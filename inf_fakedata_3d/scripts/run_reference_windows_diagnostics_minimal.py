# -*- coding: utf-8 -*-
"""
run_reference_windows_diagnostics_minimal.py

Sequential wrapper for src/train_radar_3d_window_reference_reg_diagnostic.py.
...
Run from the project root:
    ...
    python scripts/run_reference_windows_diagnostics_minimal.py --dry_run

    python scripts/run_reference_windows_diagnostics_minimal.py

Resume without rerunning completed windows:

    python scripts/run_reference_windows_diagnostics_minimal.py --skip_existing
"""
